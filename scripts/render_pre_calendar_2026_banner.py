# -*- coding: utf-8 -*-
"""
render_pre_calendar_2026_banner.py
Renders an authentic BBC News / BBC Hindi style Discover banner for the
'गन्ना प्री-कैलेंडर 2026-27 कच्चा कैलेंडर' article (<95KB WebP, 1200x675).
"""
import os
import sys
import subprocess
...
BG_PATH = r'C:\Users\caneu\.gemini\antigravity\brain\a9ecd357-12c8-4c55-ba6e-8e8e975fca16\pre_calendar_farmer_1790308024437.jpg'
...
spec = {
    "filename": "up-ganna-pre-calendar-2026-27-kaccha-calendar-guide.webp",
    "tag": "प्री-कैलेंडर 2026-27 ⚡",
    "h1": "गन्ना प्री-कैलेंडर (कच्चा कैलेंडर) जारी",
    "h2_html": "85% उत्पादन व सट्टा पर्ची तुरंत देखें • <span class='sub-highlight'>9 व 18 कुंतल का गणित</span>"
}
...
temp_html = os.path.join(BASE_DIR, "scripts", "temp_precal_banner.html")
temp_png = os.path.join(BASE_DIR, "scripts", "temp_precal_banner.png")
...
print("Rendering pre-calendar banner via Headless Chrome...")
...
if os.path.exists(temp_png):
    ...
    try:
        ...
        pass
    print("Pre-calendar banner rendering completed successfully!")
else:
